...
const PersonalSidebar = () => {
  ...
  return (
    ...
    <aside className="bg-blue-500 text-white  border-rose-gold-accent-border   border h-fit future-feed:bg-black future-feed:border-lime future-feed:text-lime  dark:bg-indigo-950 dark:border-slate-200 dark:text-slate-100 w-[200px] p-6 mt-16 ml-4 rounded-2xl  border-2  shadow-md hidden lg:block  ">
      ...
      <nav className="fixed bottom-0 w-full flex justify-around items-center future-feed:bg-black future-feed:border-lime future-feed:text-lime  dark:bg-indigo-960  border text-blue-500 dark:indigo-950 dark:text-slate-200 dark:border-slate-200  border-rose-gold-accent-border   dark:border-slate-200 p-2 lg:hidden dark:slate-100 z-50 bg-white">
