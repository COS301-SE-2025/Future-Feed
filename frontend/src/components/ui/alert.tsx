  ...
  "relative w-full rounded-lg border border-neutral-200 px-4 py-3 text-sm grid has-[>svg]:grid-cols-[calc(var(--spacing)*4)_1fr] grid-cols-[0_1fr] has-[>svg]:gap-x-3 gap-y-0.5 items-start [&>svg]:size-4 [&>svg]:translate-y-0.5 [&>svg]:text-current dark:border-neutral-800",
  {
    variants: {
      variant: {
        ...
        success: "text-green-600 bg-green-50 border-green-200 [&>svg]:text-current *:data-[slot=alert-description]:text-green-600/90 dark:text-green-400 dark:bg-green-950/20 dark:border-green-800 dark:*:data-[slot=alert-description]:text-green-400/90",
        destructive:
