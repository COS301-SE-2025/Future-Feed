...
const personalSidebar = () => {
  return (
    <>
    <aside className=" hidden sm:flex h-fit dark:bg-gray-800 dark:border-gray-800 dark:text-slate-100 w-[250px] p-6 mt-6 ml-4 rounded-2xl border  shadow-md hidden md:block">
