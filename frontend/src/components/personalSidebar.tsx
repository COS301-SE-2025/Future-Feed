...
const personalSidebar = () => {
  return (
    <>
    <aside className=" hidden sm:flex h-fit dark:bg-gray-800 dark:border-gray-800 dark:text-slate-100 w-[200px] p-6 mt-15 ml-4 rounded-2xl  border-3 border-lime-500 shadow-md hidden md:block">
      ...
      <nav className="font-bold flex flex-col space-y-4 text-lg dark:text-slate-100 ">
        ...
        <Link to="/notifications" className="flex items-center gap-3 dark:hover:text-blue-500 ">
          <Bell size={20} /> Notifications
        </Link>
        <Link to="/settings" className="flex items-center gap-3 dark:hover:text-blue-500 ">
      ...
      <nav className="fixed bottom-0 w-full flex justify-around items-center dark:bg-gray-800 border  dark:border-sky-100 p-2 sm:hidden dark:slate-100 z-50">
