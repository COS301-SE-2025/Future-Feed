        ...
        <CardContent>
          ...
          <form className="px-5 sm:px-12">
            <Button
              ...
              className="text-black mb-6 flex h-[50px] w-full items-center justify-center rounded-[25px] border border-black bg-white p-5 text-[20px] font-bold shadow-[2px_2px_4px_#888] cursor-pointer  dark:shadow-none "
            >
              Continue with:
            ...
            <div className="mb-6">
              ...
              <Input
                ...
                className="h-[50px] rounded-[25px] border border-black bg-[#e0e0e0] p-5  dark:text-slate-200 dark:placeholder:text-slate-100 "
              />
            </div>
            <div className="mb-6">
                <div className="mb-6">
            ...
            <div className="mb-1 text-right">
              <Link to="/forgotpassword" className="future-feed:text-lime text-[15px] font-bold text-black no-underline hover:underline dark:text-slate-200">
                Forgot password?
              </Link>
            </div>
            <div className="flex flex-col items-center justify-center py-6">
              <Button
                type="submit"
                className="mb-6 h-[67px] w-[186px] rounded-[25px] border border-black bg-white text-[24px] font-bold text-black shadow-[2px_2px_4px_#888] hover:bg-gray-200 hover:shadow-[1px_1px_10px_black] hover:border-blue-500   hover:border-3 cursor-pointer"
              >
                Login
              </Button>
              <span className="text-center future-feed:text-lime text-[16px]">
