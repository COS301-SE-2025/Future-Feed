      ...
      <Card className="mb-8 mt-5 w-full max-w-[828px] rounded-[20px] border-2 border-lime-500 bg-white px-10 py-8 shadow-[2px_2px_20px_#000000] sm:px-12 outline">
        ...
        <CardContent>
          ...
          <form className="px-5 sm:px-12">
            ...
            <Button
              variant="outline"
              className="mb-6 flex h-[50px] w-full items-center justify-center rounded-[25px] border border-black bg-white p-5 text-[20px] font-bold shadow-[2px_2px_4px_#888] shadow-[1px_1px_4px_gray] hover:bg-gray-200 hover:shadow-[1px_1px_10px_black] hover:border-lime-500 hover:border-2 cursor-pointer"
            >
              Continue with:
            ...
            <div className="mb-6">
              ...
              <Input
                ...
                className="h-[50px] rounded-[25px] border border-black bg-[#e0e0e0] p-5 focus:ring-2 focus:ring-lime-500 focus:ring-offset-1"
              />
            </div>
            <div className="mb-6">
                <div className="mb-6">
