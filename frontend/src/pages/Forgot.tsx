  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-gray-200 font-['Cambay',Arial,sans-serif] future-feed:bg-black future-feed:text-white">
      ...
      <Card className="relative mb-8 mt-5 w-full max-w-[828px] rounded-[20px] border-2 border-lime-500 bg-white px-10 py-8 sm:px-12 future-feed:bg-[#1a1a1a] future-feed:border-lime-500 future-feed:shadow-none">
        <Link to="/login">
          <Button
            className="absolute left-5 top-5 h-[40px] w-[40px] rounded-full border border-lime-500 bg-white p-0 hover:bg-gray-200 cursor-pointer hover:shadow-[1px_1px_10px_black] future-feed:bg-gray-200 future-feed:border-lime-500 future-feed:hover:bg-slate-400 future-feed:hover:shadow-none"
            variant="ghost"
          >
        ...
        <CardContent>
          <form className="px-5 sm:px-12">
            ...
            <div className="flex justify-center py-6">
              <Button
                type="submit"
                className="h-[67px] w-[186px] rounded-[25px] border border-black bg-white text-[20px] font-bold text-black hover:bg-gray-200 hover:shadow-[1px_1px_10px_black] hover:border-lime-500 hover:border-3 cursor-pointer"
              >
                Reset password
              </Button>
            </div>
