...
const ForgotPassword: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-gray-200 font-['Cambay',Arial,sans-serif] dark:bg-gray-800 dark:text-white">
      ...
      <Card className="relative mb-8 mt-5 w-full max-w-[828px] rounded-[20px] border-2 border-lime-500 bg-white px-10 py-8 shadow-[0_0_30px_#999] sm:px-12 dark:bg-gray-800 dark:border-slate-200 dark:shadow-none">
        <Link to="/login">
          <Button
            className="absolute left-5 top-5 h-[40px] w-[40px] rounded-full border border-lime-500 bg-white p-0 hover:bg-gray-200 cursor-pointer hover:shadow-[1px_1px_10px_black] dark:bg-gray-200 dark:border-slate-200 dark:shadow-white dark:hover:bg-gray-800 dark:hover:shadow-none"
            variant="ghost"
          >
