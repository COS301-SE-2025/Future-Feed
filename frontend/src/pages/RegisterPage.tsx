        ...
        <CardContent>
          <form className="max-h-[60vh] overflow-y-auto px-5 sm:px-12">
            ...
            <div className="flex flex-col items-center justify-center py-6">
              <Button
                type="submit"
                className="mb-6 h-[67px] w-[186px] rounded-[25px] border border-black bg-white text-[20px] font-bold text-black  hover:bg-gray-200 hover:shadow-[1px_1px_10px_black] hover:border-lime-500 hover:border-2 cursor-pointer"
              >
                Register
              </Button>
