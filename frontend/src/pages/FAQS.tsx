...
const FAQS = () => {
    ...
    return (
        <div className="p-6   min-h-screen  dark:bg-black ">
            ...
            <div className="flex border dark:border-lime-500 rounded-2xl  justify-between items-center my-3 px-4 py-3 sticky top-0  ">
                ...
                >
                    <AccordionItem value="item-1">
                        ...
                        <AccordionContent className="flex flex-col gap-4 text-balance">
                            <p className="dark:text-lime-500 font-bold">
                                Step 1
                            </p>
                            <p>
                    ...
                    <AccordionItem value="item-4">
                        ...
                        <AccordionContent className="flex flex-col gap-4 text-balance">
                            ...
                            <p className="dark:text-lime-500 font-bold">Not everyone has the same definition of what is considered private and what should be shared. If a friend or connection has posted information you prefer to be kept private, contact them and ask them to take down the content. Likewise, be considerate of others. If someone requests you remove information that you posted about them, please honor their request.</p>
                        </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-5">
                        ...
                        <AccordionContent className="flex flex-col gap-4 text-balance">
                            ...
                            <p className="dark:text-lime-500 font-bold">Step 2</p>
                            <p className="font-bold dark:text-lime-500">
                                 <MessageCircle />
