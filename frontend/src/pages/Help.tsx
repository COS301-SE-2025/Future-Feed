...
const Help = () => {
  ...
  return (
    <div className="p-6 dark:text-slate-300 min-h-screen dark:bg-blue-950">
      <h1 className="font-bold text-2xl dark:text-slate-200 dark:text-slate-200 text-right">Help Centre</h1>

      <div className="flex border dark:border-slate-200 rounded-2xl justify-between items-center my-3 px-4 py-3 sticky top-0 dark:bg-blue-950 ">
        {/* Breadcrumb */}
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
  ...
  {/* Mobile Section */}
  <h2 className="text-xl font-bold dark:text-slate-200">Mobile Devices</h2>
  ...
  {/* Desktop Section */}
  <h2 className="text-xl font-bold dark:text-slate-200 mt-8">Larger Screen Devices</h2>
  <Accordion type="single" collapsible className="w-full">
